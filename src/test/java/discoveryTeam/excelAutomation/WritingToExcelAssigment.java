...
public class WritingToExcelAssigment {
    ...
    public void writingToExcelFile() throws IOException {
        String path = "src/test/resources/book.xlsx"; //Java can open the Excel files but can not read. File do not has to be in the resource folder, it can read from directly computer as well.
